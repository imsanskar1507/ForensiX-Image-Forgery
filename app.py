...
if not st.session_state["logged_in"]:
    ...
    with col_l2:
        ...
        if st.session_state["auth_mode"] == "login":
            ...
            with st.form("reg_gate"):
                ...
                new_u = st.text_input("AGENT ID")
                new_p = st.text_input("ACCESS KEY", type="password")
                new_r = st.text_input("RECOVERY WORD")
                if st.form_submit_button("ENROLL"):
                    ...
                    try:
                        ...
                        conn.commit()
                        st.success("Enrolled! Redirecting...")
                        time.sleep(2)
            ...
            with st.form("forgot_gate"):
                ...
                f_r = st.text_input("RECOVERY WORD")
    ...
    if files:
        ...
        if st.button("INITIATE DEEP SCAN"):
            ...
            # Store in session state to survive rerun
